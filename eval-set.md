...
**`npm run eval`**. The 24 questions and their expected engine/shape live
...
Runs against Groq by default; to check the same 24 cases against Gemini instead:
...
Pass bar: all 24 cases green in one run, without needing more retries than
