...
**`npm run eval`**. The 26 questions and their expected engine/shape live
...
Runs against Groq by default; to check the same 26 cases against Gemini instead:
...
Pass bar: all 26 cases green in one run, without needing more retries than
